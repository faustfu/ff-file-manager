...
module.exports = function(app, env){
  ...
  app.get('/api/file', passport.needAuthentication(), getList);
  app.get('/api/file/:fileType/:filename', passport.needAuthentication(), getOne);
  app.post('/api/file', passport.needAuthentication(), create);
